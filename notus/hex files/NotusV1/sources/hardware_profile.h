...
/************************************************************/
#ifndef _HARDWARE_PROFILE_MODULE_
#define _HARDWARE_PROFILE_MODULE_
/************************************************************/
...
#define UART1_SPEED	UART_115200BAUD			//UART baud rate

#define I2C_SPEED	450000.0f			//I2C Clock Speedz
#define SPI_SPEED	100000.0f
#define CAN_SPEED	125000.0f
#define TIMER5_FREQ     5.0f                           //Display freq
#define TIMER3_FREQ     10.0f                           //Timeout freq
#define TIMER2_FREQ     1.0f                            //EEPROM write freq
/*************************/
...
#define CONF_U1RX TRISFbits.TRISF3
#define CONF_U1TX TRISFbits.TRISF2
...
/************************************************************/
#endif /*_HARDWARE_PROFILE_MODULE_*/
/************************************************************/
