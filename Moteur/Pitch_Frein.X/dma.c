...
volatile unsigned int * DMAiCON[] = {&DMA0CON, &DMA1CON, &DMA2CON, &DMA3CON};
volatile unsigned int * DMAiPAD[] = {&DMA0PAD, &DMA1PAD, &DMA2PAD, &DMA3PAD};
volatile unsigned int * DMAiCNT[] = {&DMA0CNT, &DMA1CNT, &DMA2CNT, &DMA3CNT};
volatile unsigned int * DMAiREQ[] = {&DMA0REQ, &DMA1REQ, &DMA2REQ, &DMA3REQ};
volatile unsigned int * DMAiSTA[] = {&DMA0STAL, &DMA1STAL, &DMA2STAL, &DMA3STAL};
volatile unsigned int * DMAiSTB[] = {&DMA0STBL, &DMA1STBL, &DMA2STBL, &DMA3STBL};
