...
/**********************CANbus Variables***************************/
extern volatile unsigned char CANTimeout; /*From isr.c*/
/*****************************************************************/
...
*/
	...
	{
		T7CONbits.TCKPS	= 0b00;
	}
	
	PR7 = (unsigned int)(FOSC/(div*freq));	
	div=1.0f/div;	
	_T7IF = 0;// Clear Timer7 interrupt
	_T7IE = 1;// Enable Timer7 interrupt
	_T7IP = 4;
