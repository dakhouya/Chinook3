...
/**********************CANbus Variables***************************/
extern volatile unsigned char can_time_out; 	/*From main.c*/
extern volatile unsigned int can_envoie_auto; 	/*From main.c*/
...
void Init_Timer2(float freq)
{
	...
	div=1.0f/div;	
	_T2IF = 0;// Clear Timer3 interrupt
	_T2IP = 7;
	_T2IE = 1;// Disable Timer3 interrupt
}
/*****************************************************************/
